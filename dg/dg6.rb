...
ataeb bujhe gele @{<M>v=[[ds][dt]]</M>@}, Thik kinA? </Q>
...
<EXR>ekai kAydAy ekhan  @{<M>y = x^2</M>@}  hale ki @{<M>dy = 2x dx</M>@}-er bhadra byAkhyA deoyA yAchchhe?</EXR>
<DISQUSB url="http://www.isical.ac.in/~arnabc/dg/dg6.html" id="dg6"/>
